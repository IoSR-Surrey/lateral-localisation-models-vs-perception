function output = takanen2013pl(insig,fs,computationType,printFigs,printMap)
...
%     
%
%   Url: http://amtoolbox.org/amt-1.6.0/doc/models/takanen2013.php
...
periph = takanen2013pl_periphery(insig,fs,printFigs);
...
if(computationType==0)
    ...
    %PL
    output.directionCues = directionCues;
    output.fc = periph.fc;
    output.leftMSO = leftMso;
    output.rightMSO = rightMso;
    output.leftLSO = leftLso;
    output.rightLSO = rightLso;
    output.leftWbMSO = leftWbMso;
    output.rightWbMSO = rightWbMso;
    ...
    [whereLeft, whatLeft] = takanen2013_onsetenhancementrd(whereLeft, whatLeft, fs, periph.fc);
    [whereRight, whatRight] = takanen2013_onsetenhancementrd(whereRight, whatRight, fs, periph.fc);
    
    %PL
    output.whereLeft = whereLeft;
    output.whereRight = whereRight;
